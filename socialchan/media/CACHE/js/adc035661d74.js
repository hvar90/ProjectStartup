	  ...
	  $('#popup-map-select-classified')		
		.show(1000, function() {
			...
			function addrSearch() {
				...
				$.getJSON('http://nominatim.openstreetmap.org/search?viewbox=-76.58,3.33, -76.4557, 3.53&format=json&limit=5&countrycodes=CO&Email=hvar90@gmail.com&q=' + inp.value, function(data) {
					var items = [];
