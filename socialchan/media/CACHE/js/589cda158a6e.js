	...
	$('#new_section').submit(function() { 	
		...
		$('.newpost form')   
            .bind('fileuploadadd', function (e, data) {				
				...
				$('#submit_newpost').click(function (e) {
			     var jqXHR = $('.newpost form').fileupload('send', {files: e.originalEvent.dataTransfer.files})
						.success(function (result, textStatus, jqXHR) {function(response) {
