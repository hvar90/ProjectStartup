									...
									$(									
										 '<img style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse left-t comment">\
											  ...
											  <div style="padding-top: 25px;">' +  msg.msg_html + '</div>\
											  <div style="float: right;  padding-top: 18px;" class="footerBoxMsg">\
													<span class="msgIcon"><input id-msg='+msg.id+' class="largerCheckbox checkboxMsg" type="checkbox" name="" value="">'+ gettext("Mark read") +' </span>\
													<span from='+msg.fromThe_id+' class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
													<span id-msg='+msg.id+' class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
...
ajax: {
  ...
  init: function() {
	...
	$('#Received').on('click','.checkboxMsg',function() {
		...
		$.api.put('message/changestateread/', JSON.parse('{"idmsg":"'+checkbox.attr('id-msg')+'","value":'+checkbox.is(':checked')+' }').success(function(response) {			   
