										 ...
										 '<img style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse left-t comment">\
											  ...
											  <div style="float: right;  padding-top: 18px;" class="footerBoxMsg">\
													<span class="msgIcon"><input id-msg='+msg.id+' class="largerCheckbox checkboxMsg" type="checkbox" name="option1" value="Milk">'+ gettext("Mark read") +' </span>\
...
ajax: {
  ...
  init: function() {
	...
	$('.footerBoxMsg .checkboxMsg').on('click',function() {
		var $this = $(this);
