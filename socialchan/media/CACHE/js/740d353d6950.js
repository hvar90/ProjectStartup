		...
		.show(1000, function() {
			...
			function chooseAddr(lat1, lng1, lat2, lng2, osm_type) {
				...
				if (osm_type == "node") {
				    ...
				    var view = map.getView() 
				    alert([position1[0] , position1[1]])
				    view.setZoom(18);				 
					view.setCenter([position1[0] , position1[1]]);			
					var vectorSource = new ol.source.Vector();
					vectorSource.addFeature(new ol.Feature(new ol.geom.Circle( [position1[0] , position1[1]], 25)));
						  ...
						  object: {
							...
							'features': [
						  
							  {
								...
								'geometry': {
								  'type': 'Polygon',
								  'coordinates': [[   [position1[1] , position1[0]],  [position2[1] , position1[0]]        ]]
								}
							  },					
							]
						  }
