  ...
  init: function() {
	 ...
	 $('.send-message #menu-emoticons .css-emoticon').on('click', function(e)
		{ 
		   ...
		   $('#messagetosend').focus().val($('#messagetosend').val() + '//' + emoticon + '//'); 
		})
		
	 $('#menu-emoticons .css-emoticon').on('click', function(e)
		{ 
		   var emoticon = e.target.getAttribute('data-tag');	
...
$(function() {
  var l = ['board', 'settings', 'style', 'posts', 'hotkeys','popups', 'ajax', 'pubsub', 'locationclassi', 'emoticons', 'messages'];
