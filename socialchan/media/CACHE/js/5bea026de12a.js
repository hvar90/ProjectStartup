	...
	jQuery(function($) {
		  $('#posts')		
			.show(1000, function() {				
				 ...
				 alert($('#title-username').attr('username')) 
					 ...
					 if (!response.length)
					 ...
					 else
					  {
					    ...
					    $.each(response, function(i, objuser) {
								tmp +='<li id="invitationcontactid'+objuser.idProfile+'" >\
										  <h2>\
											 <a href="/user/'+objuser.username+'/">'+objuser.username+'</a>\
											 <img notacceptiduser='+objuser.idProfile+' class="pointer btnNotAcceptContact" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/cancel.png" title="'+gettext('Not accept')+'"  height="17" width="17">&nbsp;&nbsp;&nbsp;<img acceptiduser='+objuser.idProfile+' class="pointer btnAcceptContact" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/accept.png" title="'+gettext('Accept')+'"  height="17" width="17">\
										  </h2>\
								      </li>';					 
							});	
