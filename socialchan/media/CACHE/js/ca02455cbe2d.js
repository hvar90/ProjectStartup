				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/searchbyuser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							    ...
							    $.each(response[0], function(i, msg) {						   
									$('<div style="margin-right: 80px; "  class="triangle-obtuse right-t">'+ msg.msg +'</div> <img style="border: 0.1em solid; float: right; " src="/media/images/blank2.png" alt="Smiley face" height="62" width="62">').appendTo('#msg-sent');
								});							
