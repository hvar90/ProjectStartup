			...
			.show(1000, function() {				
				 ...
				 $.api.get('user/getcontactrequest?_accept=application/json').success(function(response) {		
						...
						$.each(response, function(i, objuser) {
							alert(JSON.stringify(objuser.user))						
								$(	
								  '<li id="requestcontactid'+objuser.user.id+'" ><a href="/user/'+objuser.user.username+'/">'+objuser.user.username+'</a> <span class="btnremove" iduser='+objuser.user.id+'  > ('+gettext('Remove')+' )</span> </li>'					
