									...
									$(									
										 '<img style="border: 0.1em solid; float: right; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse right-t comment">\
											 ...
											 '<div style="float: right;">\
												   <span class="">\
														<img  class="" src="/media/images/marker_blue.png" title="">\
												   </span>\
											  </div>\
										   </div>'									
									 ).appendTo('#msg-sent');
									...
									$(									
									     '<img style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse left-t  comment">\
											 ...
											 '</div>'
											 +  msg.msg_html +
											 '<div style="float: right;" class="bottom-msg">\
												   <span >\
														<img  class="" src="/media/images/marker_blue.png" title="">dfsdfsdfsdfsdfsdf\
														<img  class="" src="/media/images/marker_blue.png" title="">sdfsdfsdfsdf\
														<img  class="" src="/media/images/marker_blue.png" title="">sdfsdfsdfsd\
														<img  class="" src="/media/images/marker_blue.png" title="">sdfsdfsdfsdfsdf\
												   </span>\
											  </div>\
										   </div>'										
