	...
	$('#tabs-contacts').on('click', '.btnremoveblacklist ', function(e) {              
	   ...
	   $('#tabs-contacts').on('click', '.removContact ', function(e) {              
				 ...
				 $.api.put('user/removecontact',JSON.parse('{"iduser":"'+iduser+'"}')).success(function(response) {		
					  ...
					  $("#contactsid" + iduser).fadeOut(300, function() { $(this).remove(); });													
						...
						$.each(response.contacts, function(i, profile) {
							...
							$(	
							  '<li id="contactsid'+profile.id+'" >\
							       ...
							       <img removecontactid='+profile.id+' class="pointer removContact" src="/media/images/famfamfam/icons/cancel.png" title="'+gettext('Remove')+'"  height="17" width="17">\
							   </li>'					
					 ...
					 if (!response.length)
					 ...
					 else
					  {
					    $.each(response, function(i, objuser) {
								$(	
								  '<li id="invitationcontactid'+objuser.user.id+'" ><a href="/user/'+objuser.user.username+'/"><h3>'+objuser.user.username+'</h3></a> <img notacceptiduser='+objuser.user.id+' class="pointer btnNotAcceptContact" src="/media/images/famfamfam/icons/cancel.png" title="'+gettext('Not accept')+'"  height="17" width="17">&nbsp;&nbsp;&nbsp;<img acceptiduser='+objuser.user.id+' class="pointer btnAcceptContact" src="/media/images/famfamfam/icons/accept.png" title="'+gettext('Accept')+'"  height="17" width="17"></li>'					
								 ).appendTo('#ul_invitation_contacts');
							});	
					  }																					
