										  ...
										  <div class="triangle-obtuse right-t comment">\
											  ...
											  '</div> \
											   ...
											   <div style="float: right;  padding-top: 18px;" class="">\
												 		<span class="ccccc"><input class="largerCheckbox" type="checkbox" name="option1" value="Milk">'+ gettext("Mark read") +' </span>\
														<span class="ccccc"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
														<span class="ccccc"><img  class="largerIcon" src="/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
														<span class="ccccc"><img  class="largerIcon" src="/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
											   </div>\
										   </div>'									
									 ).appendTo('#msg-sent');
								});							
