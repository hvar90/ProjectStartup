				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/searchbyuser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							    ...
							    $.each(response[0], function(i, msg) {						   
									$('<p style="margin-right: 80px;"  class="triangle-obtuse left-t">'+ msg.msg +'</p> <img style="border: 0.1em solid;  " src="/media/images/blank2.png" alt="Smiley face" height="62" width="62">').appendTo('#msg-sent');
								});							
