										 ...
										 <img style="border: 0.1em solid; float: right; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse right-t comment">\
											  ...
											  <div style="float: right;  padding-top: 18px;" class="">\
												 		<span to='+msg.to +' class="msgIcon replyMsg"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Send another message") +' </span>\
									   ...
									   '<div class="msgbox'+ msg.id +'">\
										  ...
										  <div  class="triangle-obtuse read-'+ msg.msg_read +' left-t comment ">\
											  ...
											  <div style="float: right;  padding-top: 18px;" class="">\
													...
													<span  from='+msg.fromThe+' class="msgIcon replyMsg"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
													<span id-msg='+msg.id+' class="msgIcon msgDel"><img  class="largerIcon" src="/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
													<span from='+msg.fromThe+' class="msgIcon addBlackList"><img  class="largerIcon" src="/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
											   </div>\
										  </div>\
										</div>'	
