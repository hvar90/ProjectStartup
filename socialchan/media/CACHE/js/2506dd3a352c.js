				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							    ...
							    $.each(response[0], function(i, msg) {						   
									$('<img style="border: 0.1em solid; float: right; " src="/media/images/blank2.png" alt="Smiley face" height="62" width="62"> <div class="triangle-obtuse right-t comment">'+ msg.msg +'</div>').appendTo('#msg-sent');
								});							
