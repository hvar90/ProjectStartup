	...
	jQuery(function($) {
		  $('#posts')		
			.show(1000, function() {				
				 ...
				 $.api.get('post/getpostsbyusers?username='+$('#title-username').attr('username')+'&_accept=application/json').success(function(response) {					 
	 ...
	 jQuery(function($) {
		  $('#anonymous_posts')		
			.show(1000, function() {					
				 ...
				 $.api.get('post/getanonymouspostsbyusers?username='+$('#title-username').attr('username')+'&_accept=application/json').success(function(response) {					 
...
ajaxBoard: {
  ...
  init: function() {
    ...
    $('.newpost form').fileupload({
	     ...
	     formData : $('.newpost form').serialize(),
    ...
    $('.newpost form').bind('fileuploadsubmit', function (e, data) {
       ...
       $('.newpost form').bind('fileuploadsend', function (e, data) {
    ...
    if (window.location.hostname === 'blueimp.github.io') {
        ...
        // Demo settings:
        $('.newpost form').fileupload('option', {
		...
		//$('.newpost form').fileupload({		
			...
			//done: function (e, data) {		
             //},
			//add:function (e, data) {
			   //$("#submit_newpost").off('click').on('click',function (e) {  
				     //e.preventDefault()
				     
				 //data.url = $.api.url + 'post/?html=1&_accept=application/json';
        ...
        ////},
         ...
         ////add:function (e, data) {
           ////$("#submit_newpost").on('click',function () { 
			 ////data.url = $.api.url + 'post/?html=1&_accept=application/json';          
             ////var jqXHR = data.submit()
			         ////.success(function(response) {
