			...
			.show(1000, function() {			
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgreceiveduser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							    ...
							    $.each(response[0], function(i, msg) {						   
									$('<img style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Smiley face" height="62" width="62"> <div style="border: 1.1em solid; border-color: blue;"  class="triangle-obtuse left-t">'+ msg.msg +'</div>').appendTo('#msg-received');
								});							
