			...
			.show(1000, function() {			
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {		
							    ...
							    $.each(response.results, function(i, msg) {								 				   
									$(									
										  ...
										  <div class="triangle-obtuse right-t comment">\
											  <div style="float: right;">\
											   ...
											   <div style="float: right;  padding-top: 18px;" class="">\
												 		<span class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Send another message") +' </span>\
									...
									$(									
										 '<img style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse left-t comment">\
											  ...
											  <div style="padding-top: 25px;">' +  msg.msg_html + '</div>\
											  <div style="float: right;  padding-top: 18px;" class="">\
													<span class="msgIcon"><input id-msg='+msg.id+' class="largerCheckbox" type="checkbox" name="option1" value="Milk">'+ gettext("Mark read") +' </span>\
													<span from='+msg.fromThe+' class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
													...
													<span from='+msg.fromThe+' class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
											   </div>\
										   </div>'										
