	   ...
	   jQuery(function($) {
		  $('#blacklist')		
			.show(1000, function() {				
				 ...
				 $.api.get('user/getusers?_accept=application/json').success(function(response) {		
								
							$.each(response.blacklist, function(i, profile) {						
								$(	
								  '<li id="blackuserid'+profile.id+'" ><a href="/user/'+profile.user.username+'/">'+profile.user.username+'</a> <span class="btnremoveblacklist" iduser='+profile.id+'  > ('+gettext('Remove')+' )</span> </li>'					
			...
			.show(1000, function() {				
				 ...
				 $.api.get('user/getusers?_accept=application/json').success(function(response) {		
							...
							$.each(response.contacts, function(i, profile) {						
								$(	
								  '<li id="contactsid'+profile.id+'" ><a href="/user/'+profile.user.username+'/">'+profile.user.username+'</a> <span class="btnremovecontact" iduser='+profile.id+'  > ('+gettext('Remove')+' )</span> </li>'					
