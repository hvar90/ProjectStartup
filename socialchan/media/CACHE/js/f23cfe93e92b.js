					 ...
					 if (!response.length)
					 ...
					 else
					  {
					    $.each(response, function(i, objuser) {
								$(	
								  '<li id="invitationcontactid'+objuser.user.id+'" ><h3><a href="/user/'+objuser.user.username+'/">'+objuser.user.username+'</a> <img notacceptiduser='+objuser.user.id+' class="pointer btnNotAcceptContact" src="/media/images/famfamfam/icons/cancel.png" title="'+gettext('Not accept')+'"  height="17" width="17">&nbsp;&nbsp;&nbsp;<img acceptiduser='+objuser.user.id+' class="pointer btnAcceptContact" src="/media/images/famfamfam/icons/accept.png" title="'+gettext('Accept')+'"  height="17" width="17"></h3></li>'					
								 ).appendTo('#ul_invitation_contacts');
							});	
					  }																					
