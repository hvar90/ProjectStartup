					 ...
					 if (!response.length)
					 ...
					 else
					  {
					    $.each(response, function(i, objuser) {
								$(	
								  '<li id="invitationcontactid'+objuser.user.id+'" ><a href="/user/'+objuser.user.username+'/">'+objuser.user.username+'</a> <img class="pointer" src="/media/images/famfamfam/icons/cancel.png" title="'+gettext('Not accept')+'"  height="17" width="17">&nbsp;&nbsp;&nbsp;<img class="pointer" src="/media/images/famfamfam/icons/accept.png" title="'+gettext('Accept')+'"  height="17" width="17"></li>'					
								 ).appendTo('#ul_invitation_contacts');
							});	
					  }	
