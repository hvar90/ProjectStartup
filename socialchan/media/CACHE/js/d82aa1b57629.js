			...
			.show(1000, function() {				
				 ...
				 $.api.get('user/getcontacts?_accept=application/json').success(function(response) {
						...
						$.each(response.contacts, function(i, profile) {
							...
							$(	
							  '<li id="contactsid'+profile.id+'" ><img class="imgUser" src="'+ photo +'" alt="Profile photo" height="62" width="62"><br><a href="/user/'+profile.user.username+'/">'+profile.user.username+'</a> <span class="btnremovecontact" iduser='+profile.id+'  > ('+gettext('Remove')+' )</span> </li>'					
