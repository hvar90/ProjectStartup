										 ...
										 '<img style="border: 0.1em solid; float: right; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse right-t comment">\
											  <div style="float: right; color : #808080;">\
												 <span style="color : #808080;">' + msg.pub_date + '</span>\
											  </div> \
											   <div style="padding-top: 25px;">' +  msg.msg_html + '</div>\
											   <div style="float: right;  padding-top: 18px;" class="">\
												 		<span class="msgIcon"><input class="largerCheckbox" type="checkbox" name="option1" value="Milk">'+ gettext("Mark read") +' </span>\
														<span class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
														<span class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
														<span class="msgIcon"><img  class="largerIcon" src="/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
											   </div>\
										   </div>'									
									 ).appendTo('#msg-sent');
								});							
							    ...
							    $.each(response[0], function(i, msg) {
									...
									$(									
									     '<img style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse left-t comment">\
											 ...
											 '</div> \
											  ...
											  <div style="float: right;  padding-top: 18px;" class="">\
												   <span >\
														<input class="largerCheckbox" type="checkbox" name="option1" value="Milk">'+ gettext("Mark read") +'\
														<img  class="largerIcon" src="/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +'\
														<img  class="largerIcon" src="/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +'\
														<img  class="largerIcon" src="/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +'\
												   </span>\
											  </div>\
										   </div>'										
  ...
  init: function() {
	...
	$('#profile-form').ajaxForm({
      ...
      beforeSend:  function (xhr){
		     ...
		     if(!($('#file').val().match(/\.(jpe?g|png|gif)$/))  && !($('#file').val() == '') )
			  {			  
