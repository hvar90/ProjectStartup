					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {		
							    ...
							    $.each(response.objects, function(i, msg) {								 				   
									$('<div class="msgbox'+ msg.id +'">\
										 <img username="'+ msg.to.profile_picture +'"  class="imgUser" style="border: 0.1em solid; float: right;" src="/files/'+ msg.to.profile_picture +'" alt="Profile photo" height="62" width="62"> \
