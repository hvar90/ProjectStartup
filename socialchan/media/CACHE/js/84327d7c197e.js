			...
			.show(1000, function() {				
				 ...
				 $.api.get('user/getcontactrequest?_accept=application/json').success(function(response) {		
						...
						$.each(response, function(i, objuser) {
								$(	
								  '<li id="requestcontactid'+objuser.user.id+'" ><a href="/user/'+objuser.user.username+'/">'+objuser.user.username+'</a> <img src="/media/images/famfamfam/icons/cancel.png" alt="Smiley face" height="22" width="22">&nbsp;&nbsp;&nbsp;&nbsp;<img src="/media/images/famfamfam/icons/accept.png" alt="Smiley face" height="22" width="22"></li>'					
