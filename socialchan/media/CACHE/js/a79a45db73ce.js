				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/searchbyuser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							    ...
							    $.each(response[0], function(i, msg) {						   
									$(' <img style="float: left; margin-right: 9px;" src="/media/images/blank2.png" alt="Smiley face" height="42" width="42"> <p style="border: 0.1em solid; overflow: hidden"  class="triangle-right left-t">'+ msg.msg +'</p>').appendTo('#msg-sent');
								});							
