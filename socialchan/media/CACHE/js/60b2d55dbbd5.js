				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgreceiveduser/?page='+current_page+'&_accept=application/json').success(function(response) {								
							    ...
							    $.each(response.objects, function(i, msg) {	
									...
									$(	
									   '<div class="msgbox'+ msg.id +'">\
									      <div  username="'+ msg.from.user.username +'" class="imgUser" style="float: right;">\
										     <img  style="border: 0.1em solid; " src="/files/'+ msg.from.profile_picture +'" alt="Profile photo" height="62" width="62"> \
										     <div style="text-align:center;  float:center; padding-top: 3px;">'+ msg.from.user.username +'</div>\
										  </div>\
