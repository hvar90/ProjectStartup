		...
		.show(1000, function() {
			...
			function chooseAddr(lat1, lng1, lat2, lng2, osm_type) {
				...
				if (osm_type == "node") {				
					...
					var points = [
						new OpenLayers.Geometry.Point(position1[0], position1[1]),
						new OpenLayers.Geometry.Point(position2[0], position2[1]),
						new OpenLayers.Geometry.Point(position1[0], position2[1]),
						new OpenLayers.Geometry.Point(position2[0], position1[1])
					];
					...
					view.setCenter(position1);			
					var vectorSource = new ol.source.Vector();
					vectorSource.addFeature(new ol.Feature(new OpenLayers.Geometry.Polygon([ring])));
					map.removeLayer(vectorLayer)
					vectorLayer = new ol.layer.Vector({
					  source: vectorSource,
					  style: styleFunction
