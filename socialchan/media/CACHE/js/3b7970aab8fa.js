...
emoticons: {
  init: function() {
	 ...
	 $('.css-emoticon').on('click', function(e)
		{ 
		   var emoticon = e.target.getAttribute('data-tag');	
		   $('#message').val($('#message').val()+ '<span  class="emoticon regular">' +  emoticon + '</span>'); 
		})	  
...
$(function() {
  var l = ['board', 'settings', 'style', 'posts', 'hotkeys','popups', 'ajax', 'pubsub', 'locationclassi', 'emoticons'];
