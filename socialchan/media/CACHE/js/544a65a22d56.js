...
messages: {
  init: function() {
	   ...
	   $('#tabs-messages, #contacts').on('click', '.imgUserBoxright, .imgUserBoxleft, .imgUserContact ', function(e) {              
						...
						$.each(response.contacts, function(i, profile) {
							...
							$(	
							  '<li id="contactsid'+profile.id+'" >\
							       ...
							       <img notacceptiduser='+profile.id+' class="pointer" src="/media/images/famfamfam/icons/cancel.png" title="'+gettext('Remove')+'"  height="17" width="17">\
							   </li>'					
