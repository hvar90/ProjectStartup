	    ...
	    jQuery(function($) {
		  $('#msg-received')		
			.show(1000, function() {
				...
				$('.footerBoxMsg').on('click','.checkboxMsg',function() {
					alert()
					var $this = $(this);		  
					if ($this.is(':checked')) {
						alert('checked')
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgreceiveduser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							    ...
							    $.each(response[0], function(i, msg) {														   
									$(									
										 '<img id="lala" style="border: 0.1em solid; float: left; " src="/media/images/blank2.png" alt="Profile photo" height="62" width="62"> \
