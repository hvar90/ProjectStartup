	  ...
	  $('#popup-map-select-classified')		
		.show(1000, function() {
			...
			function chooseAddr(lat1, lng1, lat2, lng2, osm_type) {
				...
				var loc1 = ol.proj.transform([lat1, lng1], 'EPSG:4326', 'EPSG:900913'); 		
				var loc2 = ol.proj.transform([lat2 , lng2], 'EPSG:4326', 'EPSG:900913');
				var bounds = loc2.concat(loc1) 		
				...
				if (osm_type == "node") {
					...
					view = map.getView()  
						alert(bounds[0]/-1 + " " +bounds[1]/-1 + " "+bounds[2]/-1 + " "+bounds[3]/-1  )            
                    view.fitExtent([bounds[0]/-1, -bounds[1]/-1, -bounds[2]/-1, -bounds[3]/-1]);
				}
			...
			function addrSearch() {
				...
				$.getJSON('http://nominatim.openstreetmap.org/search?format=json&limit=5&q=' + inp.value, function(data) {
					...
					$.each(data, function(key, val) {
						...
						items.push("<li><a class='chooseAddr' lat1=" + bb[0] + " lng1=" + bb[1] + " lat2=" + bb[2] + " lng2=" + bb[3] + " osm_type=" + bb[4] + " href='#' >" + val.display_name + '</a></li>');
					});
