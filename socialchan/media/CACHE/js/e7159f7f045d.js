...
ajaxUsers: {
  init: function() {
	...
	$('#menu-account').on('click','.addBlackList', function(e) {              
		  ...
		  var idAuthenticUser= $('#menu-account').attr('authenticUser');
		  alert(idToAddBlacklist);			
		  alert(idAuthenticUser);						
					    ...
					    $.each(response, function(i, profile) {
								tmp +='<li id="invitationcontactid'+profile.id+'" >\
										  <h2>\
											 ...
											 <img notacceptiduser='+profile.id+' class="pointer btnNotAcceptContact" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/cancel.png" title="'+gettext('Not accept')+'"  height="17" width="17">&nbsp;&nbsp;&nbsp;<img acceptiduser='+profile.id+' class="pointer btnAcceptContact" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/accept.png" title="'+gettext('Accept')+'"  height="17" width="17">\
										  </h2>\
								      </li>';					 
							});	
				 ...
				 function insermsgsents(pageNumber) {					 
					  ...
					  $.api.get('message/profile/'+idAuthenticUser+'/?msgsentuser&page='+current_page+'&_accept=application/json').success(function(response) {		
							    ...
							    $.each(response.msgs, function(i, msg) {
									...
									var photo = msg.to__profile_picture ? "http://cdn1.socialchan.com/files/"+msg.to__profile_picture : "http://cdn1.socialchan.com/media/images/users/user2.png"							 				   
									tmp_msgs += '<div class="msgbox'+ msg.id +'">\
										 <div  username="'+ msg.to__user__username +'" class="imgUserBoxright" >\
										   ...
										   <div class="textImgUser">'+ msg.to__user__username +'</div>\
										 </div>\
										  <div class="triangle-obtuse right-t comment">\
											  ...
											  <div class="footerMsg" >\
												 		<span to='+msg.to +' class="msgIcon replyMsg"><img  class="largerIcon" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Send another message") +' </span>\
				 ...
				 function insermsgrecv(pageNumber) {
					  ...
					  $.api.get('message/profile/'+idAuthenticUser+'/?msgreceiveduser&page='+current_page+'&_accept=application/json').success(function(response) {								
							    ...
							    $.each(response.msgs, function(i, msg) {																		     
									...
									var photo = msg.fromThe__profile_picture ? "http://cdn1.socialchan.com/files/"+msg.fromThe__profile_picture : "http://cdn1.socialchan.com/media/images/users/user2.png";										
								    tmp_msgs += '<div class="msgbox'+ msg.id +'">\
												  <div  username="'+ msg.fromThe__user__username +'" class="imgUserBoxleft">\
													 <img class="imgUser" src="'+ photo +'" alt="Profile photo" height="62" width="62"> \
													 <div class="textImgUser">'+ msg.fromThe__user__username +'</div>\
												  </div>\
												  <div  id="msgcontent'+ msg.id +'"  class="triangle-obtuse read-'+ msg.msg_read +' left-t comment ">\
													  ...
													  <div class="footerMsg">\
															...
															<span  from='+msg.fromThe+' class="msgIcon replyMsg"><img  class="largerIcon" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
															<span id-msg='+msg.id+' class="msgIcon msgDel"><img  class="largerIcon" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
															<span from='+msg.fromThe+' class="msgIcon addBlackList"><img  class="largerIcon" src="http://cdn1.socialchan.com/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
													   </div>\
												  </div>\
												</div>';
