	  ...
	  $('#popup-map-select-classified')		
		.show(1000, function() {
			...
			function onClick(evt) {
				  ...
				  //coordinate[0]= coordinate[0] + ( 12478.3448676 / ( maxResolution / view.getResolution() ) );
				  //coordinate[1]= coordinate[1] - ( 6019.41597746 / ( maxResolution / view.getResolution() ) );
				  $(element).popover('destroy');
				  var coor = ol.proj.transform([-76.5194 , 3.4327], 'EPSG:4326', 'EPSG:900913');
				  alert(coor[0] + '  ' + coor[1] ) 				
				  popup.setPosition([ -8518100.643806819 , 382355.2245681291]);		
				  $(element).popover({
					'placement': 'bottom',
					'animation': false,
					'html': true,
...
ajaxBoard: {
  ...
  init: function() {
    ...
    // se realiza para que no muestre la interfaz de eliminacion de imagenes y para poder envir mensajes sin archivos
