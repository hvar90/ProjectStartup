					 ...
					 if (!response[0].length)
					 ...
					 else
					  {
					    ...
					    $.each(response[0], function(i, post) {
								tmp +='<li>\
										   <a href=cccc"'+post.link+'">'+gettext(post.thread__section__name)+'</a>&nbsp;&mdash;\
...
$(function() {
  var l = ['board', 'emoticons', 'settings', 'style', 'posts', 'hotkeys','popups', 'ajaxBoard', 'ajaxMessages', 'ajaxUsers', 'pubsub', 'classified', 'messages', 'users'];
