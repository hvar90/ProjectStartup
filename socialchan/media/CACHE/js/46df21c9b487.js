	  ...
	  $('#popup-map-select-classified')		
		.show(1000, function() {
			...
			function chooseAddr(lat1, lng1, lat2, lng2, osm_type) {
				...
				var loc1 = ol.proj.transformWithProjections([lng1,lat1], fromProjection, toProjection); 		
				var loc2 = ol.proj.transformWithProjections([lng2 ,lat2], fromProjection, toProjection);
				var bounds = loc1.concat(loc2) 		
				...
				if (osm_type == "node") {
					...
					view = map.getView()  
						alert(bounds[0] + " " +bounds[1] + " "+bounds[2] + " "+bounds[3]  )            
                    view.fitExtent([bounds[0] , bounds[1], bounds[2]]  , bounds[3]);
				}
			...
			function addrSearch() {
				...
				$.getJSON('http://nominatim.openstreetmap.org/search?format=json&limit=5&q=' + inp.value, function(data) {
					...
					$.each(data, function(key, val) {
						...
						items.push("<li><a class='chooseAddr' lat1=" + bb[0] + " lng1=" + bb[3] + " lat2=" + bb[1] + " lng2=" + bb[2] + " osm_type=" + bb[4] + " href='#' >" + val.display_name + '</a></li>');
					});
