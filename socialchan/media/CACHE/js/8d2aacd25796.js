			...
			.show(1000, function() {			
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {										
							 	...
							 	var content_msg= '<img style="border: 0.1em solid; float: right; " src="/media/images/blank2.png" alt="Smiley face" height="62" width="62"> \
												  <div class="triangle-obtuse right-t comment">\
												     ...
												     '<div style="float: right;">\
													       <span class="locationButton"> \
															    <img  class="popup-show-classified-button" src="/media/images/marker_blue.png" title="">\
														   </span>\
													  </div>\
												   </div>'	
