					 ...
					 if (!response.length)
					 ...
					 else
					  {
					    $.each(response, function(i, section) {						
								$(	
								  '<li id="sectionid'+section.id+'" >\
								      <a href="/'+section.slug+'/">/'+section.slug+'/'+section.name+'</a>\
								      <img removesectionid='+section.id+' class="pointer removSection" src="/media/images/famfamfam/icons/cancel.png" title="'+gettext('Remove contact')+'"  height="17" width="17">\
								   </li>'					
								 ).appendTo('#ul_groups');
							});		
					  }					
