...
ajaxMessages: {
  init: function() {	
	...
	$('#received').on('click','.msgDel', function(e) {              
		  ...
		  $.api.del('message/'+idmsg+'/?deletemsgreceive').success(function(response) {			   
	...
	$('#sent').on('click','.msgDel', function(e) {              
			...
			var idmsg= $(this).attr('id-msg');						
			$.api.del('message/'+idmsg+'/?deletemsgsend').success(function(response) {			   
   ...
   $('#received').on('click','.checkboxMsg',function() {
		...
		$.api.put('message/'+checkbox.attr('id-msg')+'/', JSON.parse('{"value":"'+check+'" }')).success(function(response) {			   
