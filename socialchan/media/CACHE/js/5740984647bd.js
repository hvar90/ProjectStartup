		...
		.show(1000, function() {
			...
			function onClick(evt) {
				  ...
				  $(element).popover({
					...
					'animation': false,
					'html': true,
					'content': '<img src="/chieftain/media/images/blank2.png" style="width:28px; height:48px;" >' 
				  });
				 ...
				 $.api.get('user/getcontacts?_accept=application/json').success(function(response) {
					  ...
					  { 
						...
						$.each(response.contacts, function(i, profile) {
							...
							var photo = profile.profile_picture ? /chieftain/files/+profile.profile_picture : "/chieftain/media/images/users/user2.png";								
							tmp +='<li id="contactsid'+profile.id+'" >\
									   ...
									   <a href="/user/'+profile.user.username+'/">'+profile.user.username+'</a>\
									   <img removecontactid='+profile.id+' class="pointer removContact" src="/chieftain/media/images/famfamfam/icons/cancel.png" title="'+gettext('Remove contact')+'"  height="17" width="17">\
							       </li>';					
					 ...
					 else
					  {
					      ...
					      $.each(response, function(i, section) {						
								tmp +='<li class="removsection"  id="sectionid'+section.id+'" >\
										  ...
										  <img removesectionid='+section.id+' class="pointer imgremovsection" src="/chieftain/media/images/famfamfam/icons/cancel.png" title="'+gettext('Remove group')+'"  height="17" width="17">\
								      </li>';					
					    ...
					    $.each(response, function(i, objuser) {
								tmp +='<li id="invitationcontactid'+objuser.user.id+'" >\
										  <h2>\
											 ...
											 <img notacceptiduser='+objuser.user.id+' class="pointer btnNotAcceptContact" src="/chieftain/media/images/famfamfam/icons/cancel.png" title="'+gettext('Not accept')+'"  height="17" width="17">&nbsp;&nbsp;&nbsp;<img acceptiduser='+objuser.user.id+' class="pointer btnAcceptContact" src="/chieftain/media/images/famfamfam/icons/accept.png" title="'+gettext('Accept')+'"  height="17" width="17">\
										  </h2>\
								      </li>';					 
							});	
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {		
							    ...
							    $.each(response.objects, function(i, msg) {
									...
									var photo = msg.to.profile_picture ? /chieftain/files/+msg.to.profile_picture : "/chieftain/media/images/users/user2.png"							 				   
									tmp_msgs += '<div class="msgbox'+ msg.id +'">\
										 <div  username="'+ msg.to.user.username +'" class="imgUserBoxright" >\
										  ...
										  <div class="triangle-obtuse right-t comment">\
											  ...
											  <div class="footerMsg" >\
												 		<span to='+msg.to.id +' class="msgIcon replyMsg"><img  class="largerIcon" src="/chieftain/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Send another message") +' </span>\
														<span id-msg='+msg.id+' class="msgIcon msgDel"><img  class="largerIcon" src="/chieftain/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
											  </div>\
										   </div>\
										 </div>';
								});							
				 ...
				 function insermsgrecv(pageNumber) {
					  ...
					  $.api.get('message/msgreceiveduser/?page='+current_page+'&_accept=application/json').success(function(response) {								
							    ...
							    $.each(response.objects, function(i, msg) {																		     
									...
									var photo = msg.fromThe.profile_picture ? /chieftain/files/+msg.fromThe.profile_picture : "/chieftain/media/images/users/user2.png";										
								    tmp_msgs += '<div class="msgbox'+ msg.id +'">\
										  ...
										  <div  id="msgcontent'+ msg.id +'"  class="triangle-obtuse read-'+ msg.msg_read +' left-t comment ">\
											  ...
											  <div class="footerMsg">\
													...
													<span  from='+msg.fromThe.id+' class="msgIcon replyMsg"><img  class="largerIcon" src="/chieftain/media/images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
													<span id-msg='+msg.id+' class="msgIcon msgDel"><img  class="largerIcon" src="/chieftain/media/images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
													<span from='+msg.fromThe.id+' class="msgIcon addBlackList"><img  class="largerIcon" src="/chieftain/media/images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
											   </div>\
										  </div>\
										</div>'	;
