					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {		
							    ...
							    $.each(response.objects, function(i, msg) {								 				   
									$('<div class="msgbox'+ msg.id +'">\
										 <img style="border: 0.1em solid; float: right;" src="'+ msg.to.profile_picture +'" alt="Profile photo" height="62" width="62"> \
										  <div class="triangle-obtuse right-t comment">\
											  ...
											  <div style="float: right;  padding-top: 18px;" class="">\
												 		<span to='+msg.to.id +' class="msgIcon replyMsg"><img  class="largerIcon" src="images/famfamfam/icons/email2.png" title=""> '+ gettext("Send another message") +' </span>\
														<span id-msg='+msg.id+' class="msgIcon msgDel"><img  class="largerIcon" src="images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
											  </div>\
										   </div>\
										 </div>'									
									 ).appendTo('#msg-sent');
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgreceiveduser/?page='+current_page+'&_accept=application/json').success(function(response) {								
							    ...
							    $.each(response.objects, function(i, msg) {	
									...
									$(	
									   '<div class="msgbox'+ msg.id +'">\
									      <img style="border: 0.1em solid; float: left; " src="/files/'+ msg.fromThe.profile_picture +'" alt="Profile photo" height="62" width="62"> \
										  <div  id="msgcontent'+ msg.id +'"  class="triangle-obtuse read-'+ msg.msg_read +' left-t comment ">\
											  ...
											  <div style="float: right;  padding-top: 18px;" class="">\
													...
													<span  from='+msg.fromThe.id+' class="msgIcon replyMsg"><img  class="largerIcon" src="images/famfamfam/icons/email2.png" title=""> '+ gettext("Reply") +' </span>\
													<span id-msg='+msg.id+' class="msgIcon msgDel"><img  class="largerIcon" src="images/famfamfam/icons/cross2.png" title="">'+ gettext("Delete message") +' </span>\
													<span from='+msg.fromThe.id+' class="msgIcon addBlackList"><img  class="largerIcon" src="images/famfamfam/icons/user_delete2.png" title="">'+ gettext("Add to blacklist") +' </span>\
											   </div>\
										  </div>\
										</div>'	
		...
		.show(1000, function() {
			...
			function onClick(evt) {
				  ...
				  $(element).popover({
					...
					'animation': false,
					'html': true,
					'content': '<img src="images/blank2.png" style="width:28px; height:48px;" >' 
				  });
