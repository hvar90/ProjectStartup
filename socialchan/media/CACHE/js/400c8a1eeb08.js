...
messages: {
  init: function() {
	   ...
	   $(document).ready(function() {
		...
		$('#tabs-messages').on('click','.imgUser', function(e) {              
					  ...
					  $.api.get('message/msgsentuser/?page='+current_page+'&_accept=application/json').success(function(response) {		
							    ...
							    $.each(response.objects, function(i, msg) {								 				   
									$('<div class="msgbox'+ msg.id +'">\
										 <div  username="'+ msg.to.user.username +'" class="imgUserBox" style="float: right;">\
										   <img  style="border: 0.1em solid; " src="/files/'+ msg.to.profile_picture +'" alt="Profile photo" height="62" width="62"> \
										   <div style="text-align:center;  float:center; padding-top: 3px;">'+ msg.to.user.username +'</div>\
										 </div>\
				 ...
				 function insermsgsents(pageNumber) {
					  ...
					  $.api.get('message/msgreceiveduser/?page='+current_page+'&_accept=application/json').success(function(response) {								
							    ...
							    $.each(response.objects, function(i, msg) {	
									...
									$(	
									   '<div class="msgbox'+ msg.id +'">\
									      <div  username="'+ msg.fromThe.user.username +'" class="imgUserBox">\
										     <img class="imgUser" style="border: 0.1em solid; " src="/files/'+ msg.fromThe.profile_picture +'" alt="Profile photo" height="62" width="62"> \
										     <div style="text-align:center;  float:center; padding-top: 3px;">'+ msg.fromThe.user.username +'</div>\
										  </div>\
